...
Route::group(['namespace' => 'App\Http\Controllers\User'], function () {
    ...
    // Respostas
    Route::get('/user/answers', [AnswerController::class, 'index'])->name('user.answers');
    Route::get('/user/answers/show/{id}', [AnswerController::class, 'show'])->name('user.answers.show');
});
